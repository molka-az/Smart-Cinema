...
bool employe::modifier()
{
    QSqlQuery query;
        ...
        query.prepare("Update EMPLOYE set NOM=:nom,PRENOM=:prenom,AGE=:age, FONCTION=:fonction, CIN =:CIN where ID=:ID");
    ...
    QSqlQueryModel *employe ::afficher()
    {
       ...
       model->setQuery("select NOM,PRENOM,AGE,ID,CIN,FONCTION from EMPLOYE");
